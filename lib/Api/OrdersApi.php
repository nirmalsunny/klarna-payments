...
class OrdersApi
{
     ...
     *
     * @param  string $authorization_token authorization_token (required)
     * @param  \nirmalsunny\KlarnaPayments\Model\CreateOrderRequest $body body (optional)
     *
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \nirmalsunny\KlarnaPayments\Model\Order
     */
     ...
     *
     * @param  string $authorization_token (required)
     * @param  \nirmalsunny\KlarnaPayments\Model\CreateOrderRequest $body (optional)
     *
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \nirmalsunny\KlarnaPayments\Model\Order, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $authorization_token authorization_token (required)
     * @param  \nirmalsunny\KlarnaPayments\Model\CustomerTokenCreationRequest $body body (optional)
     *
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \nirmalsunny\KlarnaPayments\Model\CustomerTokenCreationResponse
     */
     ...
     *
     * @param  string $authorization_token (required)
     * @param  \nirmalsunny\KlarnaPayments\Model\CustomerTokenCreationRequest $body (optional)
     *
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \nirmalsunny\KlarnaPayments\Model\CustomerTokenCreationResponse, HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\nirmalsunny\KlarnaPayments\Model\ErrorV2',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
