...
namespace nirmalsunny\KlarnaPayments\Api;
...
use nirmalsunny\KlarnaPayments\ApiException;
use nirmalsunny\KlarnaPayments\Configuration;
use nirmalsunny\KlarnaPayments\HeaderSelector;
use nirmalsunny\KlarnaPayments\ObjectSerializer;
...
class SessionsApi
{
     ...
     *
     * @param  \nirmalsunny\KlarnaPayments\Model\Session $body session_request (required)
     *
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \nirmalsunny\KlarnaPayments\Model\MerchantSession
     */
     ...
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \nirmalsunny\KlarnaPayments\Model\MerchantSession, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \nirmalsunny\KlarnaPayments\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \nirmalsunny\KlarnaPayments\Model\Session, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @return void
     */
    public function updateCreditSession($body, $session_id)
    {
        $this->updateCreditSessionWithHttpInfo($body, $session_id);
    }
     ...
     */
    public function updateCreditSessionWithHttpInfo($body, $session_id)
    {
        $returnType = '';
        $request = $this->updateCreditSessionRequest($body, $session_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCreditSessionAsync($body, $session_id)
    {
        return $this->updateCreditSessionAsyncWithHttpInfo($body, $session_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateCreditSessionAsyncWithHttpInfo($body, $session_id)
    {
        $returnType = '';
        $request = $this->updateCreditSessionRequest($body, $session_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateCreditSessionRequest($body, $session_id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
